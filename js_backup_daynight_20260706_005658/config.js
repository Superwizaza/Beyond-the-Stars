...
GAME.Config = {
  ...
  survival: {
    ...
    campfireHealFraction: 0.05,  // eating food NEAR a campfire heals 5% max HP per food
  ...
  enemies: {
    ...
    baseSpeed: 5.5,        // stage 1 speed; +0.4 per stage
  ...
  weapons: {
    ...
    dagger:   { name: 'Dagger',    icon: '🔪', damage: 1, range: 3.5, cooldown: 0.22, shape: 'dagger', starter: true, xp: 0 },
  ...
  stages: [
    { id: 1, name: 'Foothold',   spawnEnemies: true,
  ...
  resources: {
    ...
    sand: { name: 'Sand', icon: '⏳', xp: 4 },   // Desert — melts into glass
  },
  ...
  recipes: [
    ...
    { id: 'campfire_char', output: 'campfire', amount: 1, inputs: { charcoal: 2, wood: 1 }, unlockLevel: 1 },  // charcoal fuels a campfire
